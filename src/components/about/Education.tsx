export default function EducationSection() {
    ...
    <section className="space-y-6">
      ...
      <div id="education" className="p-6 rounded-xl border border-transparent hover:border hover:border-[color-mix(in_oklch,var(--color-primary)_30%,transparent)] transition-all hover:shadow-lg">
