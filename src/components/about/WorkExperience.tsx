export default function WorkExperienceSection() {
    ...
    <section className="space-y-6">
      ...
      <div className="grid grid-cols-1 gap-8">
        {/* Berkeley */}
        <div id="berkeley" className="p-6 rounded-xl border border-transparent hover:border hover:border-[color-mix(in_oklch,var(--color-primary)_30%,transparent)] hover:shadow-lg">
          <div className="flex flex-col md:flex-row md:items-start gap-4">
            <div className="md:w-1/4">
              <div className="inline-flex items-center justify-center w-16 h-16 rounded-full bg-[color-mix(in_oklch,var(--color-primary)_15%,transparent)]">
                <img src="/assets/About/berkeley.jpg" alt="Berkeley Logo" className="w-full h-full object-contain rounded-full" />
              </div>
        ...
        <h3 className="text-xl font-semibold">Berkeley AI Research</h3>
              ...
              <div className="mt-4 flex flex-wrap gap-2">
                <a href="https://people.eecs.berkeley.edu/~gireeja/" target="_blank" rel="noopener noreferrer" className="inline-flex items-center text-xs px-3 py-1 rounded-full bg-[color-mix(in_oklch,var(--color-primary)_10%,transparent)] hover:bg-[color-mix(in_oklch,var(--color-primary)_15%,transparent)] transition-colors">
        ...
        {/* AIFARMS */}
        <div id="aifarms" className="p-6 rounded-xl border border-transparent hover:border hover:border-[color-mix(in_oklch,var(--color-primary)_30%,transparent)] hover:shadow-lg">
          <div className="flex flex-col md:flex-row md:items-start gap-4">
            <div className="md:w-1/4">
              <div className="inline-flex items-center justify-center w-16 h-16 rounded-full bg-[color-mix(in_oklch,var(--color-primary)_15%,transparent)]">
                <img src="/assets/About/ncsa.png" alt="NCSA Logo" className="w-full h-full object-contain rounded-full" />
              </div>
        ...
        <h3 className="text-xl font-semibold">AIFARMS and NCSA</h3>
              ...
              <p className="mt-3 text-sm/relaxed">
                Building agents for large scale agriculture: <a href="https://aifarms.illinois.edu/" target="_blank" rel="noopener noreferrer" className="text-[color-mix(in_oklch,var(--color-primary)_90%,currentColor)] hover:underline">aifarms.illinois.edu</a> <br />Building platform for agent building: <a href="https://uiuc.chat/" target="_blank" rel="noopener noreferrer" className="text-[color-mix(in_oklch,var(--color-primary)_90%,currentColor)] hover:underline">uiuc.chat</a>
              </p>
        ...
        {/* AAXIOM */}
        <div id="aaxiom" className="p-6 rounded-xl border border-transparent hover:border hover:border-[color-mix(in_oklch,var(--color-primary)_30%,transparent)] hover:shadow-lg">
          <div className="flex flex-col md:flex-row md:items-start gap-4">
            <div className="md:w-1/4">
