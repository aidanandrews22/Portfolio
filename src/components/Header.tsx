          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-center gap-2 md:gap-4 lg:gap-6 py-4">
            ...
            <div className="flex flex-col justify-center space-y-4 md:space-y-6 md:py-4 min-w-0 md:max-w-xl">
              ...
              <div className="space-y-3 md:space-y-4 w-full text-center md:text-left">
                <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold break-words text-balance">
                  Aidan Andrews
                </h1>
              ...
              <div className="flex items-center flex-wrap gap-3 md:gap-4 pt-2">
                ...
                >
                  ...
                  <span className="absolute bottom-1 left-1/2 -translate-x-1/2 w-0 h-0.5 bg-[var(--color-primary)] group-hover:w-full transition-[width] duration-300 motion-reduce:transition-none" />
                </a>
                ...
                <button
                  type="button"
                  onClick={toggleTheme}
                  className="relative inline-flex items-center justify-center min-h-11 min-w-11 rounded-md text-[color-mix(in_oklch,currentColor_80%,var(--color-primary))] hover:text-[var(--color-primary)] transition-colors duration-200 group cursor-pointer focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--color-primary)] focus-visible:ring-offset-2 focus-visible:ring-offset-[var(--color-background)]"
                  title={`Theme: ${theme}. Cycles system, light, dark.`}
                  aria-label={`Color theme: ${theme}. Press to cycle system, light, and dark.`}
                >
                  {theme === "light" ? (
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
